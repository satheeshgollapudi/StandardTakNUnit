...
namespace test.Utils
{
    ...
    public class CommonMethods
    {
        ...
        public static void ExtentReports()
        {
                ...
                string reportPath = @"C:\Users\gskum\OneDrive\Documents\SatheeshProject\StandardTaskNunitFramework\MarNunitPOMExmaple\Reports\\Report.html"; // Specify the path where you want to save the report
